...
public class TutorSignup extends Activity {
    ...
    public void SubmitSignup(View view) {
        ...
        if (!TextEmpty() && Password.getText().toString().equals(ConfirmPassword.getText().toString())) {
            ...
            Toast.makeText(TutorSignup.this, "You will be redirected to the login page",
            ...
            Toast.makeText(TutorSignup.this, "All text fields must be full, " +
                        ...
                        myFirebaseRef.authWithPassword(Email.getText().toString(),
                                Password.getText().toString(), new Firebase.AuthResultHandler() {
                                    ...
                                    public void onAuthenticationError(FirebaseError firebaseError) {
                                        //Auth Error
                                        Toast.makeText(TutorSignup.this, firebaseError.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
